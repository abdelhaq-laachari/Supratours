...
const Filter = () => {
  return (
    <div className="w-full bg-white p-2 rounded-lg shadow dark:bg-gray-700">
      ...
      <ul className="space-y-2 text-sm" aria-labelledby="dropdownDefault">
        <li className="flex items-center">
          ...
          <label
            htmlFor="apple"
            className="ml-2 flex items-center gap-x-2 text-sm font-medium text-gray-900 dark:text-gray-100"
          >
