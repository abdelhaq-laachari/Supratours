...
const ContactUs = () => {
  return (
    <>
      <section className="relative w-full  overflow-hidden bg-gray-50 py-20 lg:py-[80px]">
              ...
              <div className="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                <form>
                  ...
                  <div>
                    <button
                      type="submit"
                      className="bg-red-400 border-red-400 w-full rounded border p-3 text-white transition hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>
