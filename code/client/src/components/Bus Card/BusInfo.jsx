...
const BusInfo = ({
  ...
  return (
    <>
      <div className="flex flex-col space-y-6 px-5 pb-3 mb-4 w-full min-h-screen bg-[#F8F8F8] rounded-sm shadow-lg">
        ...
        <div>
          ...
          <p className="text-md text-gray-500 dark:text-gray-400">
            This ride takes {tripDuration}. <br /> It departs from Safi at {startTime}
            AM and arrives at Casablanca at {endTime} . The bus stops at 3 stations
            along the way.
          </p>
            ...
            <div className="flex flex-col md:grid grid-cols-9 mx-auto p-2 text-blue-50">
              ...
              <div className="flex flex-row-reverse md:contents">
                <div className="bg-blue-500 col-start-1 col-end-5 p-4 rounded-xl my-4 ml-auto shadow-md">
                  <h3 className="font-semibold text-lg mb-1">{startPoint}</h3>
                  <p className="leading-tight text-justify">
                    Departs from Safi at {startTime}
                  </p>
                </div>
              ...
              <div className="flex md:contents">
                ...
                <div className="bg-blue-500 col-start-6 col-end-10 p-4 rounded-xl my-4 mr-auto shadow-md">
                  ...
                  <p className="leading-tight text-justify">
                    Arrives at {endPoint} at {endTime} . <br />
                  </p>
                </div>
              </div>
            </div>
